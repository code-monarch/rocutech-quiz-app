...
export const BATCH_C4_QUESTIONS: IQuestion[] = [
  ...
  {
    "question": "Given that R is directly proportional to L and inversely proportional to P. R = 3 and L = 9 and P = 0.8, find R when L = 15 and P = 1.8",
    "options": [
      "A) 2.2",
      "B) 3.3",
      "C) 6.6",
    ...
    "correctAnswer": "A",
    "explanation": "Since R ∝ L/P, we have R = k(L/P). Using the initial values: 3 = k(9/0.8), so k = 3×0.8/9 = 0.267. Now for the new values: R = 0.267(15/1.8) = 0.267×8.33 = 2.2."
  },
  {
    "question": "Which of the following factors affect the rate of evaporation of a liquid? I. Exposed surface area II. Temperature of the surroundings III. Thermal capacity of the liquid IV. Relative humidity of the surroundings",
    "options": [
      "A) I and II only",
    ...
    "correctAnswer": "D",
    "explanation": "Factors affecting evaporation rate include exposed surface area (more area means faster evaporation), temperature (higher temperature means faster evaporation), and relative humidity (lower humidity means faster evaporation). Thermal capacity doesn't directly affect evaporation rate."
  },
  {
    "question": "What is the organic product of the reaction of C₂H₅OH with excess acidified K₂Cr₂O₇(aq)?",
    "options": [
      "A) CH₃COOH",
      "B) C₂H₅OC₂H₅",
      "C) HCOOCH₃",
    ...
    "correctAnswer": "A",
    "explanation": "Ethanol (C₂H₅OH) reacts with acidified potassium dichromate (K₂Cr₂O₇), a strong oxidizing agent. In excess oxidant, ethanol is fully oxidized to ethanoic acid (CH₃COOH)."
  },
  {
    "question": "Many doctors have _________ to Western countries for better opportunities.",
    "options": [
      "A) Migrated",
      "B) Travelled",
      "C) Immigrated",
    ...
    "correctAnswer": "A",
    "explanation": "To migrate means to move from one country or region to another, especially to find work or better living conditions."
  },
  {
    "question": "The sum of the interior angles of a regular polygon with k sides is (3k-10) right angles. Find the size of the exterior angle.",
    "options": [
      "A) 60°",
      "B) 40°",
      "C) 90°",
    ...
    "correctAnswer": "A",
    "explanation": "For a polygon with k sides, the sum of exterior angles is always 360°. Since the polygon is regular, each exterior angle = 360°/k. From (3k-10)×90° = (k-2)×180°, we find k = 6, making each exterior angle 360°/6 = 60°."
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "A hygrometer is used to measure relative humidity. A hydrometer measures the specific gravity of liquids, a barometer measures atmospheric pressure, and a hypsometer determines boiling points."
  },
  {
    "question": "When a sample of water was boiled, it lathered more readily with soap. It can be concluded that the sample most likely contained",
    "options": [
      "A) magnesium tetraoxosulphate (VI)",
      "B) suspended solids",
      "C) organic impurities",
      "D) calcium hydrogentrioxocarbonate (IV)"
    ],
    "correctAnswer": "D",
    "explanation": "Water containing calcium hydrogentrioxocarbonate (calcium bicarbonate) is characteristic of hard water, which reduces soap's ability to lather easily."
  }
];
