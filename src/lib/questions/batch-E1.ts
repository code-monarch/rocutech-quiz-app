...
export const BATCH_E1_QUESTIONS: IQuestion[] = [
  ...
  },
  {
    ...
    "correctAnswer": "D",
    "explanation": "Using the property of logarithms: log₃[x(x-8)] = 2. So x(x-8) = 3². This gives x² - 8x = 9, or x² - 8x - 9 = 0. Using the quadratic formula, x = 9 or x = -1. Since logs require positive inputs and x-8 must be positive, x = 9 is the only valid solution."
  },
  {
    "question": "A wire of resistivity 4.40 x 10⁻³Ωm has a cross-sectional area of 7.50 x 10⁻⁴m². Calculate the length of this wire that will be required to make a 4.0Ω resistor.",
    "options": [
      "A) 82.50 cm",
      "B) 68.18 cm",
      "C) 15.90 cm",
    ...
    "correctAnswer": "B",
    "explanation": "Using R = ρL/A where R is resistance, ρ is resistivity, L is length, and A is cross-sectional area. Rearranging, L = RA/ρ = 4.0Ω × 7.50 × 10⁻⁴m²/4.40 × 10⁻³Ωm = 0.6818m = 68.18cm."
  },
  {
    "question": "Which of the following salts is not prepared by precipitation?",
    "options": [
      "A) Calcium trioxocarbonate (IV)",
      "B) Sodium trioxocarbonate(IV)",
      "C) Lead (II) trioxocarbonate (IV)",
      "D) Barium trioxocarbonate (IV)"
    ],
    "correctAnswer": "B",
    "explanation": "Sodium trioxocarbonate (sodium carbonate, Na₂CO₃) is not prepared by precipitation because sodium compounds are generally soluble in water. The other carbonates listed are typically prepared through precipitation reactions as they have lower solubility."
  },
  {
    "question": "The test seemed ______ simple that we thought we would all pass.",
    "options": [
      "A) so",
      "B) very",
      "C) too",
    ...
    "correctAnswer": "A",
    "explanation": "The correct structure is 'so...that' to express a result relationship, indicating the test's simplicity led to their expectation of passing."
  },
  {
    ...
    "correctAnswer": "C",
    "explanation": "Let Adu's current age be x. Then Mr. Manu's age is 4x. Seven years ago, Adu was (x-7) and Mr. Manu was (4x-7). We have (x-7) + (4x-7) = 76, so 5x-14 = 76, thus 5x = 90, so x = 18."
  },
  {
    "question": "When a conductor mounted on an insulating stand is charged and left for some time, the conductor eventually loses all its charges. This is because",
    "options": [
    ...
    "correctAnswer": "C",
    "explanation": "The charged conductor attracts oppositely charged ions from the air, which neutralize the charge on the conductor over time."
  },
  {
    "question": "The mass of 800 cm³ of a gas X at s.t.p. is 1.0g. What is the molar mass of X? [1 mole of a gas at s.t.p. occupies 22.4 dm³]",
    "options": [
      "A) 28.0g mol⁻¹",
      "B) 36.0g mol⁻¹",
      "C) 18.0g mol⁻¹",
    ...
    "correctAnswer": "A",
    "explanation": "At s.t.p., 1 mole of gas occupies 22.4 dm³ (or 22,400 cm³). If 800 cm³ of gas X has a mass of 1.0g, then: Molar mass = (1.0g × 22,400 cm³) ÷ 800 cm³ = 28.0g mol⁻¹"
  }
];
